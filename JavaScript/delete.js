/**
 * Dette skriptet sletter en post ved å sende en DELETE-forespørsel til API-en.
 *
 * @param {string} deleteUrl - URL for slettingsforespørselen.
 * @param {string} accessTokenee - Tilgangstoken for å autentisere forespørselen.
 */

const API_BASE_URLee = "https://api.noroff.dev/api/v1";
const postIdToDelete = 5574;
